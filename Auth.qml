...
Rectangle {
    ...
    Column {
        ...
        Text {
            text:"BiblioFile uses the OpenSeed network for background services. We ask for an email address but don't keep it. All transactions will be done through user IDs."
            width:parent.width * 0.90
